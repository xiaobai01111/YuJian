          ...
          <div class="flex gap-4">
            ...
            <div class="flex-1 min-w-0">
              ...
              <div class="flex items-center gap-2 mb-2">
                ...
                <span v-if="post.status === POST_STATUS.RESOLVED" class="badge badge-success badge-sm">已解决</span>
              </div>
              ...
              <!-- Content -->
              <p class="text-slate-700 text-sm leading-relaxed line-clamp-4 mb-3 break-words">{{ truncateText(post.content, 100) }}</p>
              
              <!-- Stats -->
              <div class="flex items-center gap-5 text-xs text-slate-400">
                <button class="flex items-center gap-1 hover:text-emerald-500 transition-colors" :class="post.isLiked ? 'text-emerald-500' : ''" @click.stop="toggleLike(post)" :aria-pressed="post.isLiked">
...
import { getPostList, likePost, unlikePost, POST_STATUS, type PostVO, type PostQueryDTO } from '@/api/post'
