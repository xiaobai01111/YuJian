...
public class SetupServiceImpl implements SetupService {
    ...
    public void initialize(SetupInitDTO dto) {
        ...
        PasswordPolicyUtil.validateOrThrow(dto.getAdminPassword());
        ...
        if (adminUser == null) {
            ...
            String adminEmail = SensitiveFieldUtil.normalizeEmail(dto.getAdminEmail());
            adminUser.setEmail(adminEmail);
            adminUser.setEmailHash(SensitiveFieldUtil.hashEmail(adminEmail));
